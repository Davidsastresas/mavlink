...
TEST(ardupilotmega, AM_TELEMETRY_HIGH_LAT)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::AM_TELEMETRY_HIGH_LAT packet_in{};
    ...
    packet_in.rssi_gsm1 = 125;
    packet_in.rssi_gsm2 = 192;
    packet_in.rssi_gsm3 = 3;
    packet_in.rssi_sbd = 70;
    packet_in.comp_status_bitmask = 137;
    packet_in.telem_status_bitmask = 204;

    mavlink::ardupilotmega::msg::AM_TELEMETRY_HIGH_LAT packet1{};
    mavlink::ardupilotmega::msg::AM_TELEMETRY_HIGH_LAT packet2{};
    ...
    EXPECT_EQ(packet1.rssi_gsm1, packet2.rssi_gsm1);
    EXPECT_EQ(packet1.rssi_gsm2, packet2.rssi_gsm2);
    EXPECT_EQ(packet1.rssi_gsm3, packet2.rssi_gsm3);
    EXPECT_EQ(packet1.rssi_sbd, packet2.rssi_sbd);
    EXPECT_EQ(packet1.comp_status_bitmask, packet2.comp_status_bitmask);
    EXPECT_EQ(packet1.telem_status_bitmask, packet2.telem_status_bitmask);
}

#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, AM_TELEMETRY_HIGH_LAT)
{
    mavlink_message_t msg;
    ...
    mavlink_am_telemetry_high_lat_t packet_c {
         963497464, 963497672, 963497880, 17859, 17963, 18067, 18171, 18275, 18379, 18483, 211, 22, 89, 156, 223, 34, 101, 168, 235, 46, 113, -76, 247, 58, 125, 192, 3, 70, 137, 204
    };
    ...
    mavlink_msg_am_telemetry_high_lat_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.rssi_gsm1, packet2.rssi_gsm1);
    EXPECT_EQ(packet_in.rssi_gsm2, packet2.rssi_gsm2);
    EXPECT_EQ(packet_in.rssi_gsm3, packet2.rssi_gsm3);
    EXPECT_EQ(packet_in.rssi_sbd, packet2.rssi_sbd);
    EXPECT_EQ(packet_in.comp_status_bitmask, packet2.comp_status_bitmask);
    EXPECT_EQ(packet_in.telem_status_bitmask, packet2.telem_status_bitmask);
