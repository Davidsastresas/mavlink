...
static void mavlink_test_am_telemetry_high_lat(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_AM_TELEMETRY_HIGH_LAT >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_am_telemetry_high_lat_t packet_in = {
        963497464,963497672,963497880,17859,17963,18067,18171,18275,18379,18483,211,22,89,156,223,34,101,168,235,46,113,180,247,58,125,192,3,70,137,204
    };
    mavlink_am_telemetry_high_lat_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        packet1.rssi_gsm1 = packet_in.rssi_gsm1;
        packet1.rssi_gsm2 = packet_in.rssi_gsm2;
        packet1.rssi_gsm3 = packet_in.rssi_gsm3;
        packet1.rssi_sbd = packet_in.rssi_sbd;
        packet1.comp_status_bitmask = packet_in.comp_status_bitmask;
        packet1.telem_status_bitmask = packet_in.telem_status_bitmask;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_AM_TELEMETRY_HIGH_LAT_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_AM_TELEMETRY_HIGH_LAT_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_am_telemetry_high_lat_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_am_telemetry_high_lat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_am_telemetry_high_lat_pack(system_id, component_id, &msg , packet1.base_mode , packet1.custom_mode , packet1.landed_state , packet1.roll , packet1.pitch , packet1.heading , packet1.throttle , packet1.heading_sp , packet1.latitude , packet1.longitude , packet1.altitude_amsl , packet1.altitude_sp , packet1.airspeed , packet1.airspeed_sp , packet1.groundspeed , packet1.climb_rate , packet1.gps_nsat , packet1.gps_fix_type , packet1.battery_remaining , packet1.temperature , packet1.temperature_air , packet1.failsafe , packet1.wp_num , packet1.wp_distance , packet1.rssi_gsm1 , packet1.rssi_gsm2 , packet1.rssi_gsm3 , packet1.rssi_sbd , packet1.comp_status_bitmask , packet1.telem_status_bitmask );
    mavlink_msg_am_telemetry_high_lat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_am_telemetry_high_lat_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.base_mode , packet1.custom_mode , packet1.landed_state , packet1.roll , packet1.pitch , packet1.heading , packet1.throttle , packet1.heading_sp , packet1.latitude , packet1.longitude , packet1.altitude_amsl , packet1.altitude_sp , packet1.airspeed , packet1.airspeed_sp , packet1.groundspeed , packet1.climb_rate , packet1.gps_nsat , packet1.gps_fix_type , packet1.battery_remaining , packet1.temperature , packet1.temperature_air , packet1.failsafe , packet1.wp_num , packet1.wp_distance , packet1.rssi_gsm1 , packet1.rssi_gsm2 , packet1.rssi_gsm3 , packet1.rssi_sbd , packet1.comp_status_bitmask , packet1.telem_status_bitmask );
    mavlink_msg_am_telemetry_high_lat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_am_telemetry_high_lat_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_am_telemetry_high_lat_send(MAVLINK_COMM_1 , packet1.base_mode , packet1.custom_mode , packet1.landed_state , packet1.roll , packet1.pitch , packet1.heading , packet1.throttle , packet1.heading_sp , packet1.latitude , packet1.longitude , packet1.altitude_amsl , packet1.altitude_sp , packet1.airspeed , packet1.airspeed_sp , packet1.groundspeed , packet1.climb_rate , packet1.gps_nsat , packet1.gps_fix_type , packet1.battery_remaining , packet1.temperature , packet1.temperature_air , packet1.failsafe , packet1.wp_num , packet1.wp_distance , packet1.rssi_gsm1 , packet1.rssi_gsm2 , packet1.rssi_gsm3 , packet1.rssi_sbd , packet1.comp_status_bitmask , packet1.telem_status_bitmask );
    mavlink_msg_am_telemetry_high_lat_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_ardupilotmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_am_telemetry_high_lat(system_id, component_id, last_msg);
