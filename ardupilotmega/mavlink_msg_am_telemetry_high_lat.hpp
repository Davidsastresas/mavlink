// MESSAGE AM_TELEMETRY_HIGH_LAT support class
...
/**
 * @brief AM_TELEMETRY_HIGH_LAT message
 *
 * AM_telemetry SMS message
 */
struct AM_TELEMETRY_HIGH_LAT : mavlink::Message {
    ...
    static constexpr auto NAME = "AM_TELEMETRY_HIGH_LAT";
    ...
    inline std::string to_yaml(void) const override
    {
        ...
        ss << "  rssi_gsm1: " << +rssi_gsm1 << std::endl;
        ss << "  rssi_gsm2: " << +rssi_gsm2 << std::endl;
        ss << "  rssi_gsm3: " << +rssi_gsm3 << std::endl;
        ss << "  rssi_sbd: " << +rssi_sbd << std::endl;
        ss << "  comp_status_bitmask: " << +comp_status_bitmask << std::endl;
        ss << "  telem_status_bitmask: " << +telem_status_bitmask << std::endl;
    ...
    inline void serialize(mavlink::MsgMap &map) const override
    {
        ...
        map << rssi_gsm1;                     // offset: 40
        map << rssi_gsm2;                     // offset: 41
        map << rssi_gsm3;                     // offset: 42
        map << rssi_sbd;                      // offset: 43
        map << comp_status_bitmask;           // offset: 44
        map << telem_status_bitmask;          // offset: 45
    }
